import { MoveRight, BrainCircuit, FileOutput, FileText } from "lucide-react";
  ...
  return (
    <section className="realtive overflow-hidden bg-gray-50">
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div
            className="relative left-[calc(50%-3rem)] aspect-1155/678 w-[36.125rem] -translate-x-1/2 bg-linear-to-br from-emerald-500 via-teal-500 to-cyan-500 opacity-3 sm:left-[calc(40%-30rem)] sm:w-[40.1875rem]"
            style={{
              clipPath:
...
function StepItem({ icon, label, description }: Steps) {
  return (
    <div className="realtive p-6 rounded-2xl bg-white/5 backdrop-blur-xs border border-white/10 hover:border-rose-500 transition-colors group w-full">
